...
df = ts.get_hist_data(code='sh',start='2016-01-13',end='2017-06-18')
...
open = list(open['close'].values())
open.sort()
print(open)
print(len(open))


url = 'http://172.18.44.123:8004/history/getindexbar'

values = {"codes":["000001.SH"],"dateB":"2016-01-13","dateE":"2017-06-18","fields":["open","close"]}
