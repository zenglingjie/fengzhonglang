...
response = requests.get(url='http://172.18.44.120:8050/financing-share-bonus/stocksData/financingShareBonus/getSeoDetails',params=content)
...
del dict['id']
del dict['updatetime']
del dict['underwritingstartdate']
print(dict)


#数据库请求
data = open('F:/Quantitativetrading/F10/sql/getSeoDetailsSQL.txt', 'r+',encoding='utf-8')
...
del dictionary['UnderwritingStartDate']
DBvalue = {}
