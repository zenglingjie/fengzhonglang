...
response = requests.get(url='http://172.18.44.120:8050/trading-data/stocksData/tradingData/getBlockTrade',params=content)
...
#数据库请求
data = open('F:/Quantitativetrading/F10/sql/getBlockTradeSQL.txt', 'r+')
